...
namespace PlantPlanning
{
    public partial class FormComment : Form
    {
        ...
        public FormComment(FormMain FM, ConsurmptionForm CF)
        {
            InitializeComponent();
            fm = FM;
            cf = CF;
        ...
        private void FormComment_FormClosed(object sender, FormClosedEventArgs e)
        {
            GC.Collect();
        ...
        private void textFilterCode_TextChanged(object sender, EventArgs e)
        {
